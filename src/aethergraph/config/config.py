...
class SlackSettings(BaseModel):
    ...
    # Tokens
    bot_token: Optional[SecretStr] = None          # xoxb-...
    app_token: Optional[SecretStr] = None          # xapp-... (Socket Mode)
    signing_secret: Optional[SecretStr] = None     # only needed for HTTP/webhook
    ...
    socket_mode_enabled: bool = Field(
        default=True,
        description="Use Slack Socket Mode (WS outbound) when app_token is set."
    )
    ...
    default_team_id: Optional[str] = None            # e.g. 'T...'
    default_channel_id: Optional[str] = None         # e.g. 'C...'
    default_channel_key: Optional[str] = None        # e.g. 'slack:team/T...:chan/C...'
...
class TelegramSettings(BaseModel):
    ...
    webhook_secret: Optional[SecretStr] = None  # used ONLY for HTTP webhook verification
